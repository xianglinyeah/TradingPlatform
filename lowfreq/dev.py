...
class DevCommand:
    ...
    # (strategy-engine). See lowfreq/infra/k8s/apps/env-selector.yaml.
    # ------------------------------------------------------------------

    NAMESPACE = "trading-platform"
    SERVICES = {
        "execution-service":      {"src": "lowfreq/dotnet/execution-service",    "dotnet": True},
        "market-data-replay":     {"src": "lowfreq/dotnet/market-data-replay",   "dotnet": True},
        "strategy-engine":        {"src": "lowfreq/python/strategy-engine",      "dotnet": False},
        "market-data-gm":         {"src": "lowfreq/python/market-data-gm",       "dotnet": False},
        "execution-adapter-gm":   {"src": "lowfreq/python/execution-adapter-gm", "dotnet": False},
        "data-ingestion":         {"src": "lowfreq/python/data-ingestion",       "dotnet": False},
    }
    ...
    def run_script(self, script_name, *args):
        ...
        python_exe = Path("lowfreq/python/strategy-engine/venv/Scripts/python.exe")
    ...
    def start_all_services(self):
        ...
        print("[START-ALL] Use 'kubectl apply -f infra/k8s/services/' for infrastructure,")
    ...
    def run_test(self, test_type=None):
        ...
        lowfreq/scripts/test/core/smoke_test.py, then restore Production config
        ...
        if test_type:
            ...
            return self.run_script("lowfreq/scripts/test/smart_e2e.py", test_files[test_type])

        print("[TEST] Running tests...")
        return self.run_script("lowfreq/scripts/test/smart_e2e.py")
    ...
    def run_smoke_e2e_workflow(self) -> bool:
        ...
        try:
            ...
            success = self.run_script("lowfreq/scripts/test/core/smoke_test.py")
    ...
    def db_stats(self):
        ...
        return self.run_script("lowfreq/scripts/db/clean_database.py", "--stats")

    def db_clean(self):
        """Clean up database"""
        print("[DB] Cleaning up test data...")
        return self.run_script("lowfreq/scripts/db/clean_database.py", "--test", "--days", "7")
    ...
    def db_reset(self):
        ...
        return self.run_script("lowfreq/scripts/db/clean_database.py", "--all")

...
public final class AppConfig {
    ...
    private AppConfig(Properties p) {
        ...
        // 5 minutes: bounds how long a downstream replica can go without an
        // authoritative re-ground against the exchange's own book state. 0 disables it.
        this.resnapshotIntervalMs = parseLong(p, "coinbase.resnapshot-interval-ms", 5 * 60_000L);
